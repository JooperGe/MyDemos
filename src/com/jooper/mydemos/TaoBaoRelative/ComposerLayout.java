package com.jooper.mydemos.TaoBaoRelative;
...
public class ComposerLayout extends RelativeLayout {
	 ...
	 *            主按钮图片drawable的id
	 * @param crossId
	 *            主按钮上面两个十字圆drawable的id
	 * @param pCode
	 *            位置代码，例如“右上角”为ALIGN_PARENT_BOTTOM|ALIGN_PARENT_RIGHT
	 * @param radius
	 *            半径
		...
		rlButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (areButtonsShowing) {
					...
					cross.startAnimation(Animations.getRotateAnimation(-270, 0,
							duretime));
				} else {
					myani.startAnimationsIn(duretime);
					cross.startAnimation(Animations.getRotateAnimation(0, -270,
							duretime));
				}
