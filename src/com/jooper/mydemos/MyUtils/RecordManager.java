	...
	private void updateMicStatus() {
		if (mMediaRecorder != null && view != null) {
			...
			case 0:
				...
				break;
			case 1:
				view.setImageResource(R.drawable.composer_button);
				break;
			case 2:
				view.setImageResource(R.drawable.composer_camera);
				break;
			case 3:
				view.setImageResource(R.drawable.composer_icn_plus);
				break;
			case 4:
				view.setImageResource(R.drawable.composer_music);
				break;
			case 5:
				view.setImageResource(R.drawable.composer_place);
				break;
			default:
